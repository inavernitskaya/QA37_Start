...
public class Login {
    ...
    public void test1() {
        ...
        WebElement ex3 = wd.findElement(By.xpath("//*[@id= 'login']"));

        WebElement l4 = wd.findElement(By.cssSelector("#password"));
        WebElement ex4 = wd.findElement(By.xpath("//*[@id= 'password]"));

        WebElement l5 = wd.findElement(By.cssSelector("#login-submit"));
        WebElement ex5 = wd.findElement(By.xpath("//*[@id= 'login-submit']"));
